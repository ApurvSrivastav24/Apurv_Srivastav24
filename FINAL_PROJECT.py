...
'''def weather():
    ...
    URL = "https://www.google.com/search?q=weather&rlz=1C1NDCM_enIN1012IN1012&oq=&aqs=chrome.2.35i39i362l8.500311j0j7&sourceid=chrome&ie=UTF-8"
...
def message():
    ...
    userID = "apurvsri@yahoo.in"
    psd = 'jabharrymetsejal'
    useragent = 'Apurv Srivastav'
...
def command():
    ...
    try:
        ...
        if 'ISACC' in query:
            ...
            webbrowser.open_new_tab("https://m.facebook.com/home.php?paipv=0&eav=AfZxYJgnhLiPIVh_tFBrN8T3gwfVQqKjxFutCVmD0Ck9FWTqIASpt_NLQwhdrR_S5sU&_rdr&tbua=1")
            ...
            webbrowser.open_new_tab("https://www.google.com/search?q=weaher&rlz=1C1NDCM_enIN1012IN1012&oq=weaher&aqs=chrome..69i57j0i10i131i433i512j0i10i433i512j0i10i433i457i512j0i402l2j0i10i433i512j0i10i512j0i10i433i512j0i10i512.1860j1j7&sourceid=chrome&ie=UTF-8")
            ...
            screenshot()
        elif 'Wikipedia' in query or "open wikipedia" in query:
...
def greeting():
    speak("Hello sir!.")
    speak("I am your assistant. ISACC")
    time()
    date()
